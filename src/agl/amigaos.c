...
void os4OpenLib(void **lib) {
  ...
  if (!IOGLES2) {
    ...
    Warp3DNovaBase = so_exec.IExec->OpenLibrary("Warp3DNova.library",
                                                MIN_W3DNOVA_LIB_VERSION);
    if (!Warp3DNovaBase) {
    ...
    if (!(Warp3DNovaBase->lib_Version > MIN_W3DNOVA_LIB_VERSION ||
          (Warp3DNovaBase->lib_Version == MIN_W3DNOVA_LIB_VERSION &&
           Warp3DNovaBase->lib_Revision >= MIN_W3DNOVA_LIB_REVISION))) {
      SHUT_LOGE("Warning, your Warp3DNovaBase.library is too old, minimum is "
                "v%d.%d, please update!\n",
    ...
    LOGLES2 =
        so_exec.IExec->OpenLibrary("ogles2.library", MIN_OGLES2_LIB_VERSION);
    if (!LOGLES2) {
      SHUT_LOGE("Error, cannot open ogles2 Library!\n");
      return;
    }
    SHUT_LOGD("Using OGLES2.library v%d revision %d\n", LOGLES2->lib_Version,
              LOGLES2->lib_Revision);
    if (!(LOGLES2->lib_Version > MIN_OGLES2_LIB_VERSION ||
          (LOGLES2->lib_Version == MIN_OGLES2_LIB_VERSION &&
           LOGLES2->lib_Revision >= MIN_OGLES2_LIB_REVISION))) {
      SHUT_LOGE("Warning, your OGLES2.library is too old, minimum is v%d.%d, "
                "please update!\n",
                MIN_OGLES2_LIB_VERSION, MIN_OGLES2_LIB_REVISION);
    }
    IOGLES2 = (struct OGLES2IFace *)so_exec.IExec->GetInterface(LOGLES2, "main",
                                                                1, NULL);
    if (!IOGLES2) {
    ...
    if (LOGLES2->lib_Version > 2 ||
        (LOGLES2->lib_Version == 2 && LOGLES2->lib_Revision >= 9)) {
      hardext.prgbin_n = 1;
    }
  }
  *lib = LOGLES2;
...
static void AmiglBindAttribLocation(GLuint program, GLuint index,
                                    const GLchar *name) {
...
static void AmiglBlendColor(GLfloat red, GLfloat green, GLfloat blue,
                            GLfloat alpha) {
...
static void AmiglBlendFuncSeparate(GLenum sfactorRGB, GLenum dfactorRGB,
                                   GLenum sfactorAlpha, GLenum dfactorAlpha) {
  return IOGLES2->glBlendFuncSeparate(sfactorRGB, dfactorRGB, sfactorAlpha,
                                      dfactorAlpha);
}

static void AmiglBufferData(GLenum target, GLsizeiptr size, const void *data,
                            GLenum usage) {
  return IOGLES2->glBufferData(target, size, data, usage);
}

static void AmiglBufferSubData(GLenum target, GLintptr offset, GLsizeiptr size,
                               const void *data) {
...
static void AmiglClear(GLbitfield mask) { return IOGLES2->glClear(mask); }

static void AmiglClearColor(GLfloat red, GLfloat green, GLfloat blue,
                            GLfloat alpha) {
  return IOGLES2->glClearColor(red, green, blue, alpha);
}

static void AmiglClearDepthf(GLfloat d) { return IOGLES2->glClearDepthf(d); }

static void AmiglClearStencil(GLint s) { return IOGLES2->glClearStencil(s); }

static void AmiglColorMask(GLboolean red, GLboolean green, GLboolean blue,
                           GLboolean alpha) {
...
static void AmiglCompressedTexImage2D(GLenum target, GLint level,
                                      GLenum internalformat, GLsizei width,
                                      GLsizei height, GLint border,
                                      GLsizei imageSize, const void *data) {
  return IOGLES2->glCompressedTexImage2D(target, level, internalformat, width,
                                         height, border, imageSize, data);
}

static void AmiglCompressedTexSubImage2D(GLenum target, GLint level,
                                         GLint xoffset, GLint yoffset,
                                         GLsizei width, GLsizei height,
                                         GLenum format, GLsizei imageSize,
                                         const void *data) {
  return IOGLES2->glCompressedTexSubImage2D(
...
static void AmiglCopyTexImage2D(GLenum target, GLint level,
  ...
  return IOGLES2->glCopyTexImage2D(target, level, internalformat, x, y, width,
                                   height, border);
}

static void AmiglCopyTexSubImage2D(GLenum target, GLint level, GLint xoffset,
                                   GLint yoffset, GLint x, GLint y,
                                   GLsizei width, GLsizei height) {
  return IOGLES2->glCopyTexSubImage2D(target, level, xoffset, yoffset, x, y,
                                      width, height);
}

static GLuint AmiglCreateProgram(void) { return IOGLES2->glCreateProgram(); }

static GLuint AmiglCreateShader(GLenum type) {
  return IOGLES2->glCreateShader(type);
}

static void AmiglCullFace(GLenum mode) { return IOGLES2->glCullFace(mode); }
...
static void AmiglDepthFunc(GLenum func) { return IOGLES2->glDepthFunc(func); }
...
static void AmiglDisable(GLenum cap) { return IOGLES2->glDisable(cap); }
...
static void AmiglDrawElements(GLenum mode, GLsizei count, GLenum type,
                              const void *indices) {
  return IOGLES2->glDrawElements(mode, count, type, indices);
}

static void AmiglEnable(GLenum cap) { return IOGLES2->glEnable(cap); }

static void AmiglEnableVertexAttribArray(GLuint index) {
  return IOGLES2->glEnableVertexAttribArray(index);
}

static void AmiglFinish(void) { return IOGLES2->glFinish(); }

static void AmiglFlush(void) { return IOGLES2->glFlush(); }

static void AmiglFramebufferRenderbuffer(GLenum target, GLenum attachment,
                                         GLenum renderbuffertarget,
                                         GLuint renderbuffer) {
  return IOGLES2->glFramebufferRenderbuffer(target, attachment,
                                            renderbuffertarget, renderbuffer);
}

static void AmiglFramebufferTexture2D(GLenum target, GLenum attachment,
                                      GLenum textarget, GLuint texture,
                                      GLint level) {
  return IOGLES2->glFramebufferTexture2D(target, attachment, textarget, texture,
                                         level);
}

static void AmiglFrontFace(GLenum mode) { return IOGLES2->glFrontFace(mode); }
...
static void AmiglGetActiveAttrib(GLuint program, GLuint index, GLsizei bufSize,
                                 GLsizei *length, GLint *size, GLenum *type,
                                 GLchar *name) {
  return IOGLES2->glGetActiveAttrib(program, index, bufSize, length, size, type,
                                    name);
}

static void AmiglGetActiveUniform(GLuint program, GLuint index, GLsizei bufSize,
                                  GLsizei *length, GLint *size, GLenum *type,
                                  GLchar *name) {
  return IOGLES2->glGetActiveUniform(program, index, bufSize, length, size,
                                     type, name);
}

static void AmiglGetAttachedShaders(GLuint program, GLsizei maxCount,
...
static void AmiglGetBufferParameteriv(GLenum target, GLenum pname,
                                      GLint *params) {
  return IOGLES2->glGetBufferParameteriv(target, pname, params);
}

static GLenum AmiglGetError(void) { return IOGLES2->glGetError(); }

static void AmiglGetFloatv(GLenum pname, GLfloat *data) {
  return IOGLES2->glGetFloatv(pname, data);
}

static void AmiglGetFramebufferAttachmentParameteriv(GLenum target,
                                                     GLenum attachment,
                                                     GLenum pname,
                                                     GLint *params) {
  return IOGLES2->glGetFramebufferAttachmentParameteriv(target, attachment,
                                                        pname, params);
}
...
static void AmiglGetProgramInfoLog(GLuint program, GLsizei bufSize,
                                   GLsizei *length, GLchar *infoLog) {
  return IOGLES2->glGetProgramInfoLog(program, bufSize, length, infoLog);
}

static void AmiglGetRenderbufferParameteriv(GLenum target, GLenum pname,
                                            GLint *params) {
...
static void AmiglGetShaderInfoLog(GLuint shader, GLsizei bufSize,
                                  GLsizei *length, GLchar *infoLog) {
  return IOGLES2->glGetShaderInfoLog(shader, bufSize, length, infoLog);
}

static void AmiglGetShaderPrecisionFormat(GLenum shadertype,
                                          GLenum precisiontype, GLint *range,
                                          GLint *precision) {
  return IOGLES2->glGetShaderPrecisionFormat(shadertype, precisiontype, range,
                                             precision);
}

static void AmiglGetShaderSource(GLuint shader, GLsizei bufSize,
...
static void AmiglGetTexParameterfv(GLenum target, GLenum pname,
                                   GLfloat *params) {
...
static void AmiglGetVertexAttribfv(GLuint index, GLenum pname,
                                   GLfloat *params) {
...
static void AmiglGetVertexAttribPointerv(GLuint index, GLenum pname,
                                         void **pointer) {
...
static void AmiglReadPixels(GLint x, GLint y, GLsizei width, GLsizei height,
...
static void AmiglRenderbufferStorage(GLenum target, GLenum internalformat,
                                     GLsizei width, GLsizei height) {
...
static void AmiglShaderBinary(GLsizei count, const GLuint *shaders,
                              GLenum binaryformat, const void *binary,
                              GLsizei length) {
  return IOGLES2->glShaderBinary(count, shaders, binaryformat, binary, length);
}

static void AmiglShaderSource(GLuint shader, GLsizei count,
...
static void AmiglStencilFuncSeparate(GLenum face, GLenum func, GLint ref,
                                     GLuint mask) {
...
static void AmiglStencilOpSeparate(GLenum face, GLenum sfail, GLenum dpfail,
                                   GLenum dppass) {
  return IOGLES2->glStencilOpSeparate(face, sfail, dpfail, dppass);
}

static void AmiglTexImage2D(GLenum target, GLint level, GLint internalformat,
                            GLsizei width, GLsizei height, GLint border,
                            GLenum format, GLenum type, const void *pixels) {
  return IOGLES2->glTexImage2D(target, level, internalformat, width, height,
...
static void AmiglTexParameterfv(GLenum target, GLenum pname,
...
static void AmiglTexParameteriv(GLenum target, GLenum pname,
                                const GLint *params) {
  return IOGLES2->glTexParameteriv(target, pname, params);
}

static void AmiglTexSubImage2D(GLenum target, GLint level, GLint xoffset,
                               GLint yoffset, GLsizei width, GLsizei height,
                               GLenum format, GLenum type, const void *pixels) {
  return IOGLES2->glTexSubImage2D(target, level, xoffset, yoffset, width,
...
static void AmiglUniform1fv(GLint location, GLsizei count,
                            const GLfloat *value) {
...
static void AmiglUniform2fv(GLint location, GLsizei count,
                            const GLfloat *value) {
...
static void AmiglUniform3fv(GLint location, GLsizei count,
                            const GLfloat *value) {
...
static void AmiglUniform4f(GLint location, GLfloat v0, GLfloat v1, GLfloat v2,
                           GLfloat v3) {
  return IOGLES2->glUniform4f(location, v0, v1, v2, v3);
}

static void AmiglUniform4fv(GLint location, GLsizei count,
                            const GLfloat *value) {
  return IOGLES2->glUniform4fv(location, count, value);
}

static void AmiglUniform4i(GLint location, GLint v0, GLint v1, GLint v2,
                           GLint v3) {
...
static void AmiglUniformMatrix2fv(GLint location, GLsizei count,
                                  GLboolean transpose, const GLfloat *value) {
  return IOGLES2->glUniformMatrix2fv(location, count, transpose, value);
}

static void AmiglUniformMatrix3fv(GLint location, GLsizei count,
                                  GLboolean transpose, const GLfloat *value) {
  return IOGLES2->glUniformMatrix3fv(location, count, transpose, value);
}

static void AmiglUniformMatrix4fv(GLint location, GLsizei count,
                                  GLboolean transpose, const GLfloat *value) {
...
static void AmiglVertexAttrib4f(GLuint index, GLfloat x, GLfloat y, GLfloat z,
                                GLfloat w) {
...
static void AmiglVertexAttribPointer(GLuint index, GLint size, GLenum type,
                                     GLboolean normalized, GLsizei stride,
                                     const void *pointer) {
  return IOGLES2->glVertexAttribPointer(index, size, type, normalized, stride,
                                        pointer);
}
...
// Using glXXX name, return the function pointer of that function in ogles2
// library
#define MAP(func_name, func)                                                   \
  if (strcmp(name, func_name) == 0)                                            \
    return (void *)Ami##func;
...
void *os4GetProcAddress(const char *name) {
  ...
  EX(glViewport)
  // EX(glPolygonMode) //This is a non-standard function, and gl4es will ignore
  // it (and emulate it), even if Amiga OGLES2 driver implement it
