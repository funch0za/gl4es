...
void aglStub(void *x, ...) { return; }

// Copy/ Paste of agl specifics function, but simplified whithout the Amiga
// speicifc types
...
// TODO: something less error prone, but agl.h cannot be included here, as some
// Amiga header conflict with some GLES ones
