...
static inline void
errorShim(GLenum error) { // next glGetError will be "error" from gl4es
  if (glstate->type_error && glstate->shim_error == GL_NO_ERROR)
...
void APIENTRY_GL4ES glFrustum(GLdouble left, GLdouble right, GLdouble bottom,
                              GLdouble top, GLdouble Near, GLdouble Far);
void APIENTRY_GL4ES glGetDoublev(GLenum pname, GLdouble *params);
void APIENTRY_GL4ES glIndexf(GLfloat i);
void APIENTRY_GL4ES glInterleavedArrays(GLenum format, GLsizei stride,
                                        const GLvoid *pointer);
...
void APIENTRY_GL4ES glOrtho(GLdouble left, GLdouble right, GLdouble bottom,
                            GLdouble top, GLdouble Near, GLdouble Far);
