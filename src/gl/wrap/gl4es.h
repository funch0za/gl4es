...
void APIENTRY_GL4ES gl4es_glGetTexLevelParameterfv(GLenum target, GLint level,
                                                   GLenum pname,
                                                   GLfloat *params);
...
#define THUNK(suffix, type)                                                    \
  ...
  void APIENTRY_GL4ES gl4es_glMultiTexCoord4##suffix##v(GLenum target,         \
                                                        type *t);              \
  void APIENTRY_GL4ES gl4es_glMultiTexCoord1##suffix##ARB(GLenum target,       \
                                                          type s);             \
  void APIENTRY_GL4ES gl4es_glMultiTexCoord1##suffix##vARB(GLenum target,      \
                                                           type *t);           \
  void APIENTRY_GL4ES gl4es_glMultiTexCoord2##suffix##ARB(GLenum target,       \
                                                          type s, type t);     \
  void APIENTRY_GL4ES gl4es_glMultiTexCoord2##suffix##vARB(GLenum target,      \
                                                           type *t);           \
  void APIENTRY_GL4ES gl4es_glMultiTexCoord3##suffix##ARB(                     \
      GLenum target, type s, type t, type r);                                  \
  void APIENTRY_GL4ES gl4es_glMultiTexCoord3##suffix##vARB(GLenum target,      \
                                                           type *t);           \
  void APIENTRY_GL4ES gl4es_glMultiTexCoord4##suffix##ARB(                     \
      GLenum target, type s, type t, type r, type q);                          \
  void APIENTRY_GL4ES gl4es_glMultiTexCoord4##suffix##vARB(GLenum target,      \
                                                           type *t);
...
GLvoid APIENTRY_GL4ES glVertexAttrib2dARB(GLuint index, GLdouble v0,
                                          GLdouble v1);
GLvoid APIENTRY_GL4ES glVertexAttrib3fARB(GLuint index, GLfloat v0, GLfloat v1,
                                          GLfloat v2);
GLvoid APIENTRY_GL4ES glVertexAttrib3sARB(GLuint index, GLshort v0, GLshort v1,
                                          GLshort v2);
GLvoid APIENTRY_GL4ES glVertexAttrib3dARB(GLuint index, GLdouble v0,
                                          GLdouble v1, GLdouble v2);
GLvoid APIENTRY_GL4ES glVertexAttrib4sARB(GLuint index, GLshort v0, GLshort v1,
                                          GLshort v2, GLshort v3);
GLvoid APIENTRY_GL4ES glVertexAttrib4dARB(GLuint index, GLdouble v0,
                                          GLdouble v1, GLdouble v2,
                                          GLdouble v3);
GLvoid APIENTRY_GL4ES glVertexAttrib4NubARB(GLuint index, GLubyte x, GLubyte y,
                                            GLubyte z, GLubyte w);
