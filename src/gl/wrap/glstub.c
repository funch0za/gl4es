...
#ifdef BCMHOST
STUB(void, glDiscardFramebufferEXT,
     (GLenum target, GLsizei numAttachments, const GLenum *attachments));
#endif

/*
STUB(void glBlendEquationSeparatei(GLuint buf, GLenum modeRGB, GLenum
modeAlpha)) STUB(void glBlendFuncSeparatei(GLuint buf, GLenum srcRGB, GLenum
dstRGB, GLenum srcAlpha, GLenum dstAlpha))
*/
STUB(void, glClearAccum,
     (GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha));
// STUB(void,glColorMaterial,(GLenum face, GLenum mode));
STUB(void, glCopyPixels,
...
STUB(void, glPrioritizeTextures,
...
// STUB(void,glPixelMapusv,(GLenum map,GLsizei mapsize, const GLushort
// *values));
...
// STUB(void glIndexPointer(GLenum  type,  GLsizei  stride,  const GLvoid *
// pointer));
#undef STUB
