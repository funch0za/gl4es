...
// void APIENTRY_GL4ES gl4es_glBlendEquationSeparate(GLenum modeRGB, GLenum
// modeAlpha);
void APIENTRY_GL4ES gl4es_glBlendEquationSeparatei(GLuint buf, GLenum modeRGB,
                                                   GLenum modeAlpha);
// void APIENTRY_GL4ES gl4es_glBlendFuncSeparate(GLenum srcRGB, GLenum dstRGB,
...
void APIENTRY_GL4ES gl4es_glCopyPixels(GLint x, GLint y, GLsizei width,
...
// void APIENTRY_GL4ES gl4es_glGetTexImage(GLenum target, GLint level, GLenum
// format, GLenum type, GLvoid * img); void APIENTRY_GL4ES
// gl4es_glGetTexLevelParameterfv(GLenum target, GLint level, GLenum pname,
// GLfloat *params); void APIENTRY_GL4ES gl4es_glGetTexLevelParameteriv(GLenum
...
void APIENTRY_GL4ES gl4es_glColorTable(GLenum target, GLenum internalformat,
...
void APIENTRY_GL4ES gl4es_glPrioritizeTextures(GLsizei n,
...
void APIENTRY_GL4ES gl4es_glFeedbackBuffer(GLsizei size, GLenum type,
                                           GLfloat *buffer);
