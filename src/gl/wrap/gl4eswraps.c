...
void APIENTRY_GL4ES gl4es_glGetTexGendv(GLenum coord, GLenum pname,
                                        GLdouble *params) {
  GLfloat fparams[4];
...
void APIENTRY_GL4ES gl4es_glGetTexGeniv(GLenum coord, GLenum pname,
                                        GLint *params) {
  GLfloat fparams[4];
  gl4es_glGetTexGenfv(coord, pname, fparams);
  if (pname == GL_TEXTURE_GEN_MODE)
...
void APIENTRY_GL4ES gl4es_glGetMaterialiv(GLenum face, GLenum pname,
                                          GLint *params) {
  GLfloat fparams[4];
...
void APIENTRY_GL4ES gl4es_glGetLightiv(GLenum light, GLenum pname,
                                       GLint *params) {
  GLfloat fparams[4];
...
void APIENTRY_GL4ES gl4es_glGetTexLevelParameteriv(GLenum target, GLint level,
                                                   GLenum pname,
                                                   GLint *params) {
  GLfloat fparams[4];
...
void APIENTRY_GL4ES gl4es_glFrustum(GLdouble left, GLdouble right,
...
void APIENTRY_GL4ES gl4es_glLightiv(GLenum light, GLenum pname,
                                    GLint *iparams) {
  GLfloat params[4];
  switch (pname) {
  case GL_AMBIENT:
...
void APIENTRY_GL4ES gl4es_glMaterialiv(GLenum face, GLenum pname,
                                       GLint *iparams) {
...
void APIENTRY_GL4ES gl4es_glMultiTexCoord2f(GLenum target, GLfloat s,
                                            GLfloat t) {
  gl4es_glMultiTexCoord4f(target, s, t, 0, 1);
}
void APIENTRY_GL4ES gl4es_glMultiTexCoord3f(GLenum target, GLfloat s, GLfloat t,
                                            GLfloat r) {
  gl4es_glMultiTexCoord4f(target, s, t, r, 1);
}
/*void glMultiTexCoord4f(GLenum target, GLfloat s, GLfloat t, GLfloat r, GLfloat
q) { glMultiTexCoord2f(target, s, t);
}*/
...
/*
void glBlendFuncSeparateEXT (GLenum sfactorRGB, GLenum dfactorRGB, GLenum
sfactorAlpha, GLenum dfactorAlpha) { glBlendFuncSeparate (sfactorRGB,
dfactorRGB, sfactorAlpha, dfactorAlpha);
}
*/
void APIENTRY_GL4ES gl4es_glOrtho(GLdouble left, GLdouble right,
...
#define GL_RECT(suffix, type)                                                  \
  void APIENTRY_GL4ES gl4es_glRect##suffix(type x1, type y1, type x2,          \
                                           type y2) {                          \
  ...
  void APIENTRY_GL4ES gl4es_glRect##suffix##v(const type *v1,                  \
                                              const type *v2) {                \
...
#define THUNK(suffix, type, invmax)                                            \
  ...
  void APIENTRY_GL4ES gl4es_glColor4##suffix##v(const type *v) {               \
    gl4es_glColor4f(v[0] * invmax, v[1] * invmax, v[2] * invmax,               \
                    v[3] * invmax);                                            \
  }                                                                            \
  void APIENTRY_GL4ES gl4es_glSecondaryColor3##suffix(type r, type g,          \
                                                      type b) {                \
  ...
  /* index */                                                                  \
  void APIENTRY_GL4ES gl4es_glIndex##suffix(type c) { gl4es_glIndexf(c); }     \
  ...
  void APIENTRY_GL4ES gl4es_glRasterPos4##suffix(type x, type y, type z,       \
                                                 type w) {                     \
  ...
  void APIENTRY_GL4ES gl4es_glVertex4##suffix(type r, type g, type b,          \
                                              type w) {                        \
  ...
  void APIENTRY_GL4ES gl4es_glTexCoord4##suffix(type s, type t, type r,        \
                                                type q) {                      \
  ...
  void APIENTRY_GL4ES gl4es_glMultiTexCoord1##suffix##v(GLenum target,         \
                                                        type *t) {             \
    gl4es_glMultiTexCoord4f(target, t[0], 0, 0, 1);                            \
  }                                                                            \
  void APIENTRY_GL4ES gl4es_glMultiTexCoord2##suffix(GLenum target, type s,    \
                                                     type t) {                 \
    gl4es_glMultiTexCoord4f(target, s, t, 0, 1);                               \
  }                                                                            \
  void APIENTRY_GL4ES gl4es_glMultiTexCoord2##suffix##v(GLenum target,         \
                                                        type *t) {             \
    gl4es_glMultiTexCoord4f(target, t[0], t[1], 0, 1);                         \
  }                                                                            \
  void APIENTRY_GL4ES gl4es_glMultiTexCoord3##suffix(GLenum target, type s,    \
                                                     type t, type r) {         \
    gl4es_glMultiTexCoord4f(target, s, t, r, 1);                               \
  }                                                                            \
  void APIENTRY_GL4ES gl4es_glMultiTexCoord3##suffix##v(GLenum target,         \
                                                        type *t) {             \
    gl4es_glMultiTexCoord4f(target, t[0], t[1], t[2], 1);                      \
  }                                                                            \
  void APIENTRY_GL4ES gl4es_glMultiTexCoord4##suffix(GLenum target, type s,    \
                                                     type t, type r, type q) { \
    gl4es_glMultiTexCoord4f(target, s, t, r, q);                               \
  }                                                                            \
  void APIENTRY_GL4ES gl4es_glMultiTexCoord4##suffix##v(GLenum target,         \
                                                        type *t) {             \
    gl4es_glMultiTexCoord4f(target, t[0], t[1], t[2], t[3]);                   \
  }
...
void APIENTRY_GL4ES gl4es_glIndexfv(const GLfloat *c) { gl4es_glIndexf(*c); }
...
void APIENTRY_GL4ES gl4es_glRasterPos4f(GLfloat x, GLfloat y, GLfloat z,
                                        GLfloat w) {
...
// eval
void APIENTRY_GL4ES gl4es_glEvalCoord1d(GLdouble u) { gl4es_glEvalCoord1f(u); }
...
// texgen
void APIENTRY_GL4ES gl4es_glTexGend(GLenum coord, GLenum pname,
                                    GLdouble param) {
...
void APIENTRY_GL4ES gl4es_glTexGendv(GLenum coord, GLenum pname,
...
void APIENTRY_GL4ES gl4es_glTexGeniv(GLenum coord, GLenum pname,
                                     const GLint *params) {
  GLfloat tmp[4];
  tmp[0] = params[0];
  if ((pname == GL_OBJECT_PLANE) || (pname == GL_EYE_PLANE))
...
// transforms
void APIENTRY_GL4ES gl4es_glRotated(GLdouble angle, GLdouble x, GLdouble y,
                                    GLdouble z) {
...
void APIENTRY_GL4ES gl4es_glBlendEquationSeparatei(GLuint buf, GLenum modeRGB,
                                                   GLenum modeAlpha) {
...
void APIENTRY_GL4ES gl4es_glBlendFuncSeparatei(GLuint buf, GLenum srcRGB,
...
// VertexArray stuff
void APIENTRY_GL4ES gl4es_glVertexAttrib1f(GLuint index, GLfloat v0) {
  GLfloat f[4] = {0, 0, 0, 1};
  f[0] = v0;
  gl4es_glVertexAttrib4fv(index, f);
};
void APIENTRY_GL4ES gl4es_glVertexAttrib2f(GLuint index, GLfloat v0,
                                           GLfloat v1) {
  GLfloat f[4] = {0, 0, 0, 1};
  f[0] = v0;
  f[1] = v1;
...
void APIENTRY_GL4ES gl4es_glVertexAttrib3f(GLuint index, GLfloat v0, GLfloat v1,
                                           GLfloat v2) {
  GLfloat f[4] = {0, 0, 0, 1};
  f[0] = v0;
  f[1] = v1;
...
#define THUNK(suffix, type, M2)                                                \
  ...
  void APIENTRY_GL4ES gl4es_glVertexAttrib2##suffix(GLuint index, type v0,     \
                                                    type v1) {                 \
    GLfloat f[4] = {0, 0, 0, 1};                                               \
    f[0] = v0;                                                                 \
    f[1] = v1;                                                                 \
  ...
  void APIENTRY_GL4ES gl4es_glVertexAttrib3##suffix(GLuint index, type v0,     \
                                                    type v1, type v2) {        \
    GLfloat f[4] = {0, 0, 0, 1};                                               \
    f[0] = v0;                                                                 \
    f[1] = v1;                                                                 \
  ...
  void APIENTRY_GL4ES gl4es_glVertexAttrib4##suffix(                           \
      GLuint index, type v0, type v1, type v2, type v3) {                      \
    GLfloat f[4] = {0, 0, 0, 1};                                               \
    f[0] = v0;                                                                 \
    f[1] = v1;                                                                 \
    f[2] = v2;                                                                 \
  ...
  void APIENTRY_GL4ES gl4es_glVertexAttrib1##suffix##v(GLuint index,           \
                                                       const type *v) {        \
    GLfloat f[4] = {0, 0, 0, 1};                                               \
    f[0] = v[0];                                                               \
    gl4es_glVertexAttrib4fv(index, f);                                         \
  };                                                                           \
  void APIENTRY_GL4ES gl4es_glVertexAttrib2##suffix##v(GLuint index,           \
                                                       const type *v) {        \
    GLfloat f[4] = {0, 0, 0, 1};                                               \
    f[0] = v[0];                                                               \
    f[1] = v[1];                                                               \
  ...
  void APIENTRY_GL4ES gl4es_glVertexAttrib3##suffix##v(GLuint index,           \
                                                       const type *v) {        \
    GLfloat f[4] = {0, 0, 0, 1};                                               \
    f[0] = v[0];                                                               \
    f[1] = v[1];                                                               \
  ...
  AliasExport##M2##_1(void, glVertexAttrib1##suffix, ,                         \
                      (GLuint index, type v0));                                \
  AliasExport##M2##_1(void, glVertexAttrib2##suffix, ,                         \
                      (GLuint index, type v0, type v1));                       \
  AliasExport##M2##_1(void, glVertexAttrib3##suffix, ,                         \
                      (GLuint index, type v0, type v1, type v2));              \
  AliasExport##M2##_1(void, glVertexAttrib4##suffix, ,                         \
                      (GLuint index, type v0, type v1, type v2, type v3));     \
  AliasExport(void, glVertexAttrib1##suffix##v, ,                              \
              (GLuint index, const type *v));                                  \
  AliasExport(void, glVertexAttrib2##suffix##v, ,                              \
              (GLuint index, const type *v));                                  \
...
#define THUNK(suffix, type, norm)                                              \
  void APIENTRY_GL4ES gl4es_glVertexAttrib4##suffix##v(GLuint index,           \
                                                       const type *v) {        \
    GLfloat f[4] = {0, 0, 0, 1};                                               \
    f[0] = v[0];                                                               \
    f[1] = v[1];                                                               \
  ...
  AliasExport(void, glVertexAttrib4##suffix##v, ,                              \
              (GLuint index, const type *v));                                  \
  void APIENTRY_GL4ES gl4es_glVertexAttrib4N##suffix##v(GLuint index,          \
                                                        const type *v) {       \
    GLfloat f[4] = {0, 0, 0, 1};                                               \
    f[0] = v[0] / norm;                                                        \
    f[1] = v[1] / norm;                                                        \
  ...
  AliasExport(void, glVertexAttrib4N##suffix##v, ,                             \
              (GLuint index, const type *v));
...
#undef THUNK
void APIENTRY_GL4ES gl4es_glVertexAttrib4Nub(GLuint index, GLubyte v0,
                                             GLubyte v1, GLubyte v2,
                                             GLubyte v3) {
  GLfloat f[4] = {0, 0, 0, 1};
  f[0] = v0 / 255.f;
  f[1] = v1 / 255.f;
...
AliasExport(void, glVertexAttrib4Nub, ,
            (GLuint index, GLubyte v0, GLubyte v1, GLubyte v2, GLubyte v3));
...
AliasExport(GLvoid, glVertexAttrib2f, ARB,
            (GLuint index, GLfloat v0, GLfloat v1));
AliasExport(GLvoid, glVertexAttrib2s, ARB,
            (GLuint index, GLshort v0, GLshort v1));
AliasExport_D_1(GLvoid, glVertexAttrib2d, ARB,
                (GLuint index, GLdouble v0, GLdouble v1));
AliasExport(GLvoid, glVertexAttrib3f, ARB,
            (GLuint index, GLfloat v0, GLfloat v1, GLfloat v2));
AliasExport(GLvoid, glVertexAttrib3s, ARB,
            (GLuint index, GLshort v0, GLshort v1, GLshort v2));
AliasExport_D_1(GLvoid, glVertexAttrib3d, ARB,
                (GLuint index, GLdouble v0, GLdouble v1, GLdouble v2));
AliasExport(GLvoid, glVertexAttrib4s, ARB,
            (GLuint index, GLshort v0, GLshort v1, GLshort v2, GLshort v3));
AliasExport_D_1(GLvoid, glVertexAttrib4d, ARB,
                (GLuint index, GLdouble v0, GLdouble v1, GLdouble v2,
                 GLdouble v3));
AliasExport(GLvoid, glVertexAttrib4Nub, ARB,
...
AliasExport(GLvoid, glVertexAttrib4Nusv, ARB,
...
AliasExport_D(void, glOrtho, ,
              (GLdouble left, GLdouble right, GLdouble bottom, GLdouble top,
               GLdouble Near, GLdouble Far));
AliasExport(void, glGetMaterialiv, ,
...
// AliasExport(void,glDrawRangeElements,,(GLenum mode,GLuint start,GLuint
...
AliasExport(void, glRasterPos4f, ,
...
AliasExport(void, glGetTexGendv, ,
...
AliasExport_M(void, glMapGrid2d, ,
...
#define GL_RECT(suffix, type, M2)                                              \
  AliasExport##M2(void, glRect##suffix, ,                                      \
...
AliasExport(void, glMultiTexCoord3f, ,
...
#define THUNK(suffix, type, M2)                                                \
  ...
  AliasExport##M2(void, glSecondaryColor3##suffix, ,                           \
  ...
  AliasExport##M2(void, glRasterPos4##suffix, ,                                \
  ...
  AliasExport##M2(void, glVertex4##suffix, ,                                   \
                  (type x, type y, type z, type w));                           \
  ...
  AliasExport##M2(void, glTexCoord4##suffix, ,                                 \
                  (type s, type t, type r, type q));                           \
  AliasExport(void, glTexCoord4##suffix##v, , (type * t));                     \
  AliasExport##M2##_1(void, glMultiTexCoord1##suffix, ,                        \
                      (GLenum target, type s));                                \
  AliasExport(void, glMultiTexCoord1##suffix##v, , (GLenum target, type * t)); \
  AliasExport##M2##_1(void, glMultiTexCoord2##suffix, ,                        \
                      (GLenum target, type s, type t));                        \
  AliasExport(void, glMultiTexCoord2##suffix##v, , (GLenum target, type * t)); \
  AliasExport##M2##_1(void, glMultiTexCoord3##suffix, ,                        \
                      (GLenum target, type s, type t, type r));                \
  AliasExport(void, glMultiTexCoord3##suffix##v, , (GLenum target, type * t)); \
  AliasExport##M2##_1(void, glMultiTexCoord4##suffix, ,                        \
                      (GLenum target, type s, type t, type r, type q));        \
  AliasExport(void, glMultiTexCoord4##suffix##v, , (GLenum target, type * t)); \
  AliasExport##M2##_1(void, glMultiTexCoord1##suffix, ARB,                     \
                      (GLenum target, type s));                                \
  AliasExport(void, glMultiTexCoord1##suffix##v, ARB,                          \
              (GLenum target, type * t));                                      \
  AliasExport##M2##_1(void, glMultiTexCoord2##suffix, ARB,                     \
                      (GLenum target, type s, type t));                        \
  AliasExport(void, glMultiTexCoord2##suffix##v, ARB,                          \
              (GLenum target, type * t));                                      \
  AliasExport##M2##_1(void, glMultiTexCoord3##suffix, ARB,                     \
                      (GLenum target, type s, type t, type r));                \
  AliasExport(void, glMultiTexCoord3##suffix##v, ARB,                          \
              (GLenum target, type * t));                                      \
  AliasExport##M2##_1(void, glMultiTexCoord4##suffix, ARB,                     \
                      (GLenum target, type s, type t, type r, type q));        \
  AliasExport(void, glMultiTexCoord4##suffix##v, ARB,                          \
              (GLenum target, type * t));
...
AliasExport(void, glMultiTexCoord2f, ARB,
            (GLenum target, GLfloat s, GLfloat t));
AliasExport(void, glMultiTexCoord3f, ARB,
            (GLenum target, GLfloat s, GLfloat t, GLfloat r));
...
// AliasExport(void,glDrawRangeElements,EXT,(GLenum mode,GLuint start,GLuint
// end,GLsizei count,GLenum type,const void *indices));
