...
#define GOM(T, t)                                                              \
  ...
  switch (type) {
    ...
    GOV(GL_INT, GLint);
    GOV(GL_BOOL, /*GLboolean*/ GLint); // GLboolean is an unsigned char and is
                                       // not suitable here
...
void APIENTRY_GL4ES gl4es_glGetUniformfv(GLuint program, GLint location,
  ...
  if (k != kh_end(glprogram->uniform)) {
    ...
    for (int i = 0; i < n; i++)
      params[i] =
          fl[i]; // this is probably good, int->float is straight forward
    noerrorShim();
    return;
  }
...
void GoUniformfv(program_t *glprogram, GLint location, int size, int count,
                 const GLfloat *value) {
  DBG(printf("GoUniformfv(%p[%d], %d, %d, %d, %p) =>(%f...)\n", glprogram,
             glprogram->id, location, size, count, value, value[0]);)
  if (location == -1) {
    noerrorShim();
    return;
  }
  ...
  if (size != n_uniform(m->type) || !is_uniform_float(m->type) ||
      count > m->size) {
    errorShim(GL_INVALID_OPERATION);
    return;
  }
  ...
  if (memcmp((char *)glprogram->cache.cache + m->cache_offs, value, rsize) ==
      0) {
    noerrorShim();
...
void GoUniformiv(program_t *glprogram, GLint location, int size, int count,
                 const GLint *value) {
  ...
  m = kh_value(glprogram->uniform, k);
  if (size != n_uniform(m->type) || !is_uniform_int(m->type) ||
      count > m->size) {
    errorShim(GL_INVALID_OPERATION);
    return;
  }
...
void APIENTRY_GL4ES gl4es_glProgramUniform1f(GLuint program, GLint location,
                                             GLfloat v0) {
  DBG(printf("glUniform1f(%d, %f)\n", location, v0);)
  PUSH_IF_COMPILING(glUniform1f);
  CHECK_PROGRAM(void, program);
...
void APIENTRY_GL4ES gl4es_glProgramUniform2f(GLuint program, GLint location,
...
void APIENTRY_GL4ES gl4es_glProgramUniform3f(GLuint program, GLint location,
                                             GLfloat v0, GLfloat v1,
                                             GLfloat v2) {
  DBG(printf("glUniform3f(%d, %f, %f, %f)\n", location, v0, v1, v2);)
  PUSH_IF_COMPILING(glUniform3f);
...
void APIENTRY_GL4ES gl4es_glProgramUniform4f(GLuint program, GLint location,
...
void APIENTRY_GL4ES gl4es_glProgramUniform1i(GLuint program, GLint location,
                                             GLint v0) {
  DBG(printf("glUniform1i(%d, %d)\n", location, v0);)
  PUSH_IF_COMPILING(glUniform1i);
  CHECK_PROGRAM(void, program);
...
void APIENTRY_GL4ES gl4es_glProgramUniform2i(GLuint program, GLint location,
                                             GLint v0, GLint v1) {
  DBG(printf("glUniform2i(%d, %d, %d)\n", location, v0, v1);)
  PUSH_IF_COMPILING(glUniform2i);
  GLint fl[2] = {v0, v1};
...
void APIENTRY_GL4ES gl4es_glProgramUniform3i(GLuint program, GLint location,
...
void APIENTRY_GL4ES gl4es_glProgramUniform4i(GLuint program, GLint location,
                                             GLint v0, GLint v1, GLint v2,
                                             GLint v3) {
  DBG(printf("glUniform4i(%d, %d, %d, %d, %d)\n", location, v0, v1, v2, v3);)
  PUSH_IF_COMPILING(glUniform4i);
...
// TODO: the "v" variant and matrix variant cannot be pushed simply...
void APIENTRY_GL4ES gl4es_glProgramUniform1fv(GLuint program, GLint location,
                                              GLsizei count,
                                              const GLfloat *value) {
  DBG(printf("glUniform1fv(%d, %d, %p) =>(%f)\n", location, count, value,
             value[0]);)
...
void APIENTRY_GL4ES gl4es_glProgramUniform2fv(GLuint program, GLint location,
                                              GLsizei count,
                                              const GLfloat *value) {
  DBG(printf("glUniform2fv(%d, %d, %p) =>(%f %f)\n", location, count, value,
             value[0], value[1]);)
...
void APIENTRY_GL4ES gl4es_glProgramUniform3fv(GLuint program, GLint location,
                                              GLsizei count,
                                              const GLfloat *value) {
  DBG(printf("glUniform3fv(%d, %d, %p) =>(%f %f, %f)\n", location, count, value,
             value[0], value[1], value[2]);)
...
void APIENTRY_GL4ES gl4es_glProgramUniform4fv(GLuint program, GLint location,
                                              GLsizei count,
                                              const GLfloat *value) {
  DBG(printf("glUniform4fv(%d, %d, %p) =>(%f %f, %f, %f)\n", location, count,
             value, value[0], value[1], value[2], value[3]);)
...
void APIENTRY_GL4ES gl4es_glProgramUniform1iv(GLuint program, GLint location,
                                              GLsizei count,
                                              const GLint *value) {
  PUSH_IF_COMPILING(glUniform1iv);
  CHECK_PROGRAM(void, program);
...
void APIENTRY_GL4ES gl4es_glProgramUniform2iv(GLuint program, GLint location,
                                              GLsizei count,
                                              const GLint *value) {
  PUSH_IF_COMPILING(glUniform2iv);
  CHECK_PROGRAM(void, program);
...
void APIENTRY_GL4ES gl4es_glProgramUniform3iv(GLuint program, GLint location,
                                              GLsizei count,
                                              const GLint *value) {
  PUSH_IF_COMPILING(glUniform3iv);
  CHECK_PROGRAM(void, program);
...
void APIENTRY_GL4ES gl4es_glProgramUniform4iv(GLuint program, GLint location,
                                              GLsizei count,
                                              const GLint *value) {
  PUSH_IF_COMPILING(glUniform4iv);
  CHECK_PROGRAM(void, program);
...
void APIENTRY_GL4ES gl4es_glProgramUniformMatrix2fv(GLuint program,
                                                    GLint location,
                                                    GLsizei count,
                                                    GLboolean transpose,
                                                    const GLfloat *value) {
...
void GoUniformMatrix2fv(program_t *glprogram, GLint location, GLsizei count,
                        GLboolean transpose, const GLfloat *value) {
  DBG(printf("GoUniformMatrix2fv(%p[%d], %d, %d, %d, %p)\n", glprogram,
             glprogram->id, location, count, transpose, value);)
  if (location == -1) {
    noerrorShim();
    return;
  }
...
void APIENTRY_GL4ES gl4es_glProgramUniformMatrix3fv(GLuint program,
                                                    GLint location,
                                                    GLsizei count,
                                                    GLboolean transpose,
                                                    const GLfloat *value) {
...
void GoUniformMatrix3fv(program_t *glprogram, GLint location, GLsizei count,
                        GLboolean transpose, const GLfloat *value) {
...
void APIENTRY_GL4ES gl4es_glUniformMatrix4fv(GLint location, GLsizei count,
  ...
  DBG(printf("glUniformMatrix4fv(%d, %d, %d, %p) p=>(%f, %f, %f, %f, %f...)\n",
             location, count, transpose, value, value[0], value[1], value[2],
             value[3], value[4]);)
...
void APIENTRY_GL4ES gl4es_glProgramUniformMatrix4fv(GLuint program,
                                                    GLint location,
                                                    GLsizei count,
                                                    GLboolean transpose,
                                                    const GLfloat *value) {
...
void GoUniformMatrix4fv(program_t *glprogram, GLint location, GLsizei count,
                        GLboolean transpose, const GLfloat *value) {
  DBG(printf("GoUniformMatrix4fv(%p[%d], %d, %d, %d, %p) p=>(%f, %f, %f, %f, "
             "%f...)\n",
...
AliasExport(GLvoid, glUniform3f, ARB,
            (GLint location, GLfloat v0, GLfloat v1, GLfloat v2));
AliasExport(GLvoid, glUniform4f, ARB,
            (GLint location, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3));
...
AliasExport(GLvoid, glUniform3i, ARB,
            (GLint location, GLint v0, GLint v1, GLint v2));
AliasExport(GLvoid, glUniform4i, ARB,
            (GLint location, GLint v0, GLint v1, GLint v2, GLint v3));

AliasExport(GLvoid, glUniform1fv, ARB,
            (GLint location, GLsizei count, const GLfloat *value));
AliasExport(GLvoid, glUniform2fv, ARB,
            (GLint location, GLsizei count, const GLfloat *value));
AliasExport(GLvoid, glUniform3fv, ARB,
            (GLint location, GLsizei count, const GLfloat *value));
AliasExport(GLvoid, glUniform4fv, ARB,
            (GLint location, GLsizei count, const GLfloat *value));

AliasExport(GLvoid, glUniform1iv, ARB,
            (GLint location, GLsizei count, const GLint *value));
AliasExport(GLvoid, glUniform2iv, ARB,
            (GLint location, GLsizei count, const GLint *value));
AliasExport(GLvoid, glUniform3iv, ARB,
            (GLint location, GLsizei count, const GLint *value));
AliasExport(GLvoid, glUniform4iv, ARB,
            (GLint location, GLsizei count, const GLint *value));
...
AliasExport(GLvoid, glGetUniformfv, ARB,
            (GLhandleARB programObj, GLint location, GLfloat *params));
AliasExport(GLvoid, glGetUniformiv, ARB,
            (GLhandleARB programObj, GLint location, GLint *params));

// ===============
AliasExport(void, glProgramUniform1f, ,
            (GLuint program, GLint location, GLfloat v0));
AliasExport(void, glProgramUniform2f, ,
            (GLuint program, GLint location, GLfloat v0, GLfloat v1));
AliasExport(void, glProgramUniform3f, ,
            (GLuint program, GLint location, GLfloat v0, GLfloat v1,
             GLfloat v2));
AliasExport(void, glProgramUniform4f, ,
            (GLuint program, GLint location, GLfloat v0, GLfloat v1, GLfloat v2,
             GLfloat v3));
AliasExport(void, glProgramUniform1i, ,
            (GLuint program, GLint location, GLint v0));
AliasExport(void, glProgramUniform2i, ,
            (GLuint program, GLint location, GLint v0, GLint v1));
AliasExport(void, glProgramUniform3i, ,
            (GLuint program, GLint location, GLint v0, GLint v1, GLint v2));
AliasExport(void, glProgramUniform4i, ,
            (GLuint program, GLint location, GLint v0, GLint v1, GLint v2,
             GLint v3));
AliasExport(void, glProgramUniform1fv, ,
            (GLuint program, GLint location, GLsizei count,
             const GLfloat *value));
AliasExport(void, glProgramUniform2fv, ,
            (GLuint program, GLint location, GLsizei count,
             const GLfloat *value));
AliasExport(void, glProgramUniform3fv, ,
            (GLuint program, GLint location, GLsizei count,
             const GLfloat *value));
AliasExport(void, glProgramUniform4fv, ,
            (GLuint program, GLint location, GLsizei count,
             const GLfloat *value));
AliasExport(void, glProgramUniform1iv, ,
            (GLuint program, GLint location, GLsizei count,
             const GLint *value));
AliasExport(void, glProgramUniform2iv, ,
            (GLuint program, GLint location, GLsizei count,
             const GLint *value));
AliasExport(void, glProgramUniform3iv, ,
            (GLuint program, GLint location, GLsizei count,
             const GLint *value));
AliasExport(void, glProgramUniform4iv, ,
            (GLuint program, GLint location, GLsizei count,
             const GLint *value));
...
AliasExport(void, glProgramUniform1f, EXT,
            (GLuint program, GLint location, GLfloat v0));
AliasExport(void, glProgramUniform2f, EXT,
            (GLuint program, GLint location, GLfloat v0, GLfloat v1));
AliasExport(void, glProgramUniform3f, EXT,
            (GLuint program, GLint location, GLfloat v0, GLfloat v1,
             GLfloat v2));
AliasExport(void, glProgramUniform4f, EXT,
            (GLuint program, GLint location, GLfloat v0, GLfloat v1, GLfloat v2,
             GLfloat v3));
AliasExport(void, glProgramUniform1i, EXT,
            (GLuint program, GLint location, GLint v0));
AliasExport(void, glProgramUniform2i, EXT,
            (GLuint program, GLint location, GLint v0, GLint v1));
AliasExport(void, glProgramUniform3i, EXT,
            (GLuint program, GLint location, GLint v0, GLint v1, GLint v2));
AliasExport(void, glProgramUniform4i, EXT,
            (GLuint program, GLint location, GLint v0, GLint v1, GLint v2,
             GLint v3));
AliasExport(void, glProgramUniform1fv, EXT,
            (GLuint program, GLint location, GLsizei count,
             const GLfloat *value));
AliasExport(void, glProgramUniform2fv, EXT,
            (GLuint program, GLint location, GLsizei count,
             const GLfloat *value));
AliasExport(void, glProgramUniform3fv, EXT,
            (GLuint program, GLint location, GLsizei count,
             const GLfloat *value));
AliasExport(void, glProgramUniform4fv, EXT,
            (GLuint program, GLint location, GLsizei count,
             const GLfloat *value));
AliasExport(void, glProgramUniform1iv, EXT,
            (GLuint program, GLint location, GLsizei count,
             const GLint *value));
AliasExport(void, glProgramUniform2iv, EXT,
            (GLuint program, GLint location, GLsizei count,
             const GLint *value));
AliasExport(void, glProgramUniform3iv, EXT,
            (GLuint program, GLint location, GLsizei count,
             const GLint *value));
AliasExport(void, glProgramUniform4iv, EXT,
            (GLuint program, GLint location, GLsizei count,
             const GLint *value));
