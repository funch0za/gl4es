...
static int StageExclusive[] = {
    ...
    1, // STAGE_POLYGON
    1, // STAGE_DRAW
    1, // STAGE_POSTDRAW   (used for "pending", i.e. post glEnd(), in case a
       // similar glBegin occurs)
    0  // STAGE_LAST
};
...
void rlColor4f(renderlist_t *list, GLfloat r, GLfloat g, GLfloat b,
               GLfloat a) FASTMATH;
...
void rlMultiTexCoord4f(renderlist_t *list, GLenum texture, GLfloat s, GLfloat t,
                       GLfloat r, GLfloat q) FASTMATH;
void rlMultiTexCoord2fv(renderlist_t *list, GLenum texture,
                        GLfloat *v) FASTMATH;
void rlMultiTexCoord4fv(renderlist_t *list, GLenum texture,
                        GLfloat *v) FASTMATH;
void rlVertex4f(renderlist_t *list, GLfloat x, GLfloat y, GLfloat z,
                GLfloat w) FASTMATH;
void rlVertex3fv(renderlist_t *list, GLfloat *v) FASTMATH;
void rlVertex4fv(renderlist_t *list, GLfloat *v) FASTMATH;
void rlSecondary3f(renderlist_t *list, GLfloat r, GLfloat g,
                   GLfloat b) FASTMATH;
void rlRasterOp(renderlist_t *list, int op, GLfloat x, GLfloat y,
                GLfloat z) FASTMATH;
