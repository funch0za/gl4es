...
void APIENTRY_GL4ES gl4es_glTexSubImage3D(GLenum target, GLint level,
  ...
  gl4es_glTexSubImage2D(GL_TEXTURE_3D, level, xoffset, yoffset, width, height,
                        format, type, data);
}
...
void APIENTRY_GL4ES gl4es_glTexStorage3D(GLenum target, GLsizei levels,
  ...
  DBG(printf("glTexStorage3D(%s, %d, %s, %d, %d, %d)\n", PrintEnum(target),
             levels, PrintEnum(internalformat), width, height, depth);)
  gl4es_glTexImage3D(target, 0, internalformat, width, height, depth, 0,
...
void APIENTRY_GL4ES gl4es_glCopyTexSubImage3D(GLenum target, GLint level,
  ...
  gl4es_glCopyTexSubImage2D(GL_TEXTURE_3D, level, xoffset, yoffset, x, y, width,
                            height);
}
