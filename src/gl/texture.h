...
void APIENTRY_GL4ES gl4es_glTexImage3D(GLenum target, GLint level,
                                       GLint internalFormat, GLsizei width,
...
void APIENTRY_GL4ES gl4es_glTexSubImage3D(GLenum target, GLint level,
                                          GLint xoffset, GLint yoffset,
...
void APIENTRY_GL4ES gl4es_glCopyTexSubImage3D(GLenum target, GLint level,
                                              GLint xoffset, GLint yoffset,
...
void APIENTRY_GL4ES gl4es_glTexStorage2D(GLenum target, GLsizei levels,
                                         GLenum internalformat, GLsizei width,
                                         GLsizei height);
void APIENTRY_GL4ES gl4es_glTexStorage3D(GLenum target, GLsizei levels,
                                         GLenum internalformat, GLsizei width,
                                         GLsizei height, GLsizei depth);
...
typedef struct {
  ...
  GLenum binded_attachment; // What binding (texture, depth, stencil,
                            // depth_stencil)
  GLuint renderdepth;       // in case renderbuffer where used instead...
  GLuint renderstencil;
  int trace;    // internal use for debug
  GLvoid *data; // in case we want to keep a copy of it (it that case, always
...
#define IS_ANYTEX(T)                                                           \
  (T & ((1 << ENABLED_TEX2D) | (1 << ENABLED_TEX1D) | (1 << ENABLED_TEX3D) |   \
        (1 << ENABLED_TEXTURE_RECTANGLE)))
...
void realize_1texture(GLenum target, int TMU, gltexture_t *tex,
                      glsampler_t *sampler);
...
int samplerParameterfv(glsampler_t *sampler, GLenum pname,
                       const GLfloat *param);
// return 0 if pname not handled, 1 if ok (or ok with error)
