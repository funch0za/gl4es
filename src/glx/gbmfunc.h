...
GBMFUNC(int, gbm_device_is_format_supported,
...
GBMFUNC(void, gbm_bo_set_user_data,
...
GBMFUNC(struct gbm_bo *, gbm_bo_create,
        (struct gbm_device * gbm, uint32_t width, uint32_t height,
         uint32_t format, uint32_t usage))
GBMFUNC(struct gbm_surface *, gbm_surface_create,
        (struct gbm_device * gbm, uint32_t width, uint32_t height,
         uint32_t format, uint32_t flags))
GBMFUNC(void, gbm_surface_destroy, (struct gbm_surface * surf))
GBMFUNC(struct gbm_bo *, gbm_surface_lock_front_buffer,
        (struct gbm_surface * surf))
GBMFUNC(void, gbm_surface_release_buffer,
