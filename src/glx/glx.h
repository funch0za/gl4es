...
struct __GLXContextRec {
  ...
  void *nativewin;
  int contextType; // 0 = Window, 1 = PBuffer, 2 = PixmapBuffer, 3 = Emulated
                   // PixmapBuffer (with PBuffer)
};
...
GLXContext gl4es_glXCreateContext(Display *dpy, XVisualInfo *visual,
...
int gl4es_glXQueryContext(Display *display, GLXContext ctx, int attribute,
                          int *value);
